...
// @name:zh-CN          淘宝搜索PLUS
// @name:zh-TW          淘寶搜索PLUS
// @name                淘宝搜索PLUS | taobao search plus
...
// @description         淘宝搜索页面自动加载店铺评分，无需鼠标悬停查看！快速查看店铺评分以及同行对比！ | 搜索页面自定义排序方式与显示方式 | Auto load shop information, customize the default sort order and ui style(gird or list).
